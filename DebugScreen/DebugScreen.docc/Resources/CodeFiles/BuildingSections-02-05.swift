...
private extension ActionsSectionBuilder {
    ...
    func configureActionList() -> DebugScreenActionList {
        ...
        let actionList = DebugScreenActionList(title: L10n.ActionList.title,
    ...
    func getActionListModels() -> [Action] {
        ...
        let defaultAction = DebugScreenAction(title: L10n.ActionList.defaultActionTitle) {
            debugPrint("✅ Default action complete")
        }

        let destructiveAction = DebugScreenAction(title: L10n.Actions.destructiveTitle,
                                                  style: .destructive) {
