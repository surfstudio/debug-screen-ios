...
private extension ServerSelectionSectionBuilder {
    ...
    func configureSelectionList() -> [MainTableBlock] {
        ...
        let items: [ServersSelectionListItem] = [
            .init(name: L10n.ServerSelection.firstServerTitle,
                  value: "https://surf.ru/address/prod"),
            .init(name: L10n.ServerSelection.secondServerTitle,
                  value: "https://surf.ru/address/test"),
            .init(name: L10n.ServerSelection.thirdServerTitle,
                  value: "https://surf.ru/address/stage")
        ]
        ...
        let selectionList = ServersSelectionList(items: items,
